        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={6} sm={4} md={6} lg={8}>
            <Stack spacing={2}>
              ...
              <TextField id="outlined-basic" label="Correo" variant="outlined" defaultValue={teacher.email} />
              <TextField id="outlined-basic" label="Teléfono" variant="outlined" defaultValue={teacher.phone} />
              <TextField id="outlined-basic" label="Dirección" variant="outlined" defaultValue={teacher.address} />
              <TextField id="outlined-basic" label="Año" variant="outlined" defaultValue={teacher.age} />
          ...
          <Grid item xs={6} sm={4} md={6} lg={8}>
            <Stack spacing={2}>
              <Select labelId="demo-simple-select-label" defaultValue={teacher.typeDocument} id="demo-simple-select" label="Type·Document">
                ...
                <MenuItem value="Identification·Card">Identification Card</MenuItem>
              </Select>
